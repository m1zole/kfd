...
__attribute__((constructor)) static void initializer(void)
{
	...
	bootInfo_setObject(@"JB_SANDBOX_EXTENSIONS", [NSString stringWithUTF8String:JB_SandboxExtensions]);	//XXX temporary
	bootInfo_setObject(@"JB_ROOT_PATH", [NSString stringWithUTF8String:JB_RootPath]);	//XXX temporary
