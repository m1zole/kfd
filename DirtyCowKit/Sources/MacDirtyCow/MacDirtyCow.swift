...
public enum MacDirtyCow {
    ...
    public static func Swiftcallps() -> Int32 {
        return callps()
    }
    
    public static func returnPID(exec: String) -> String {
        var toReturn = ""
        ...
        do {
            ...
            print("Failed to get PID of executable!")
        }
        
        return toReturn
    }
    
    public static func findPID(from input: String, process exec: String) -> String? {
    ...
    public static func enableJIT(pidApp: String) {
        let pid = pidApp
        let args: [String] = [pid]
        let argc = args.count
