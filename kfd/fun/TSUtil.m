...
NSString* unsandboxPath(void)
{
    return [[NSBundle mainBundle].bundlePath stringByAppendingPathComponent:@"unsandbox"];
}
...
int runLdid(NSArray* args)
{
    NSString* ldidPath = @"/var/mobile/ldid";
    NSMutableArray* argsM = args.mutableCopy ?: [NSMutableArray new];
