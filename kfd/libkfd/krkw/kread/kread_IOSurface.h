...
// Hardcode
#define isa 0x0
#define PixelFormat 0xA4
#define AllocSize 0xAC
#define UseCountPtr 0xC0
#define IndexedTimestampPtr 0x360
#define ReadDisplacement 0x14
