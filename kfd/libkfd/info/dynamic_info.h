...
const struct dynamic_info kern_versions[] = {
    ...
    //iPhone 12 mini 16.1.2
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff007847e40,                   //ok
        .kernelcache__gPhysSize = 0xfffffff007847e48,                   //ok
        .kernelcache__gVirtBase = 0xfffffff007846028,                   //ok
        .kernelcache__perfmon_devices = 0xfffffff00a3dc330,
        .kernelcache__perfmon_dev_open = 0xfffffff007ecb5d0,
        .kernelcache__ptov_table = 0xfffffff0077fb9c0,                  //ok
    ...
    //iPhone SE 2020 iOS 16.6 beta1
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0079541b8,                   //ok
        .kernelcache__gPhysSize = 0xfffffff0079541c0,                   //ok
        .kernelcache__gVirtBase = 0xfffffff007952370,                   //ok
        .kernelcache__perfmon_devices = 0xfffffff00a4bd520,
        .kernelcache__perfmon_dev_open = 0xfffffff007f07d78,
        .kernelcache__ptov_table = 0xfffffff0079079b8,                  //no
