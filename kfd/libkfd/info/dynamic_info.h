...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 23.0.0: Tue May 23 00:20:53 PDT 2023; root:xnu-10002.0.40.502.3~1/RELEASE_ARM64_T8010",
        ...
        .kernelcache__cdevsw = 0xfffffff0078d5760,
        .kernelcache__gPhysBase = 0xfffffff00715cb18,
        .kernelcache__gPhysSize = 0xfffffff00715cb20,
        .kernelcache__gVirtBase = 0xfffffff00715ad18,
        .kernelcache__perfmon_devices = 0xfffffff0079192f0,
        .kernelcache__perfmon_dev_open = 0xfffffff0073501b0,
        .kernelcache__ptov_table = 0xfffffff00710e508,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff007918770,
        .kernelcache__vm_pages = 0xfffffff00710b6f8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00710d480,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff007918768,
        .kernelcache__vn_kqfilter = 0xfffffff0073ad32c,
    },
};
